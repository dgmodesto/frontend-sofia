        ...
        return (
            <div>
                ...
                <div className='jumbotron text-center'>
                    <img className='logo' src='./logo_sofia.jpeg' alt='Sofia' width='50%' height='50%' />
                    <p>Somos especializados em análise de sentimento utilizando Inteligência Artificial</p>
